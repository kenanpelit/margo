...
complete -c mctl -n "__fish_mctl_needs_command" -f -a "perf" -d 'Per-output frame counters: renders, empties, empty ratio, queue errors'
...
complete -c mctl -n "__fish_mctl_using_subcommand perf" -l json
complete -c mctl -n "__fish_mctl_using_subcommand perf" -l watch -d 'Refresh the table once a second until interrupted (ignored with --json)'
complete -c mctl -n "__fish_mctl_using_subcommand perf" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "dispatch" -d 'Dispatch a compositor command by name (margo\'s internal dispatch table)'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "log" -d 'File-logging controls (~/.local/state/margo/logs/margo-*.log)'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "plugin" -d 'List / enable / disable plugins (~/.config/margo/plugins/<name>/)'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "run" -d 'One-shot Rhai script execution against the live compositor (W3.2)'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "migrate" -d 'Translate a Hyprland or Sway/i3 config to margo (W4.4)'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "tags" -d 'Set the active tagset on an output (raw tag bitmask)'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "client-tags" -d 'Mutate the focused client\'s tag bitmask (advanced)'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "layout" -d 'Set layout by index (0-based, matches the compositor\'s layout list)'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "quit" -d 'Quit the compositor cleanly'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "reload" -d 'Reload `~/.config/margo/config.conf`'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "theme" -d 'Live-swap the visual theme preset'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "session-save" -d 'Save per-monitor tag/layout state to session.json'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "session-load" -d 'Restore per-monitor tag/layout state from session.json'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "get" -d 'Raw IPC query — print one JSON reply and exit'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "watch" -d 'Stream state updates from margo (runs until Ctrl-C)'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "status" -d 'Print current status (one shot)'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "actions" -d 'List every dispatch action margo accepts (for binds and `mctl dispatch`)'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "twilight" -d 'Twilight (built-in blue-light filter) control'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "config-errors" -d 'Show config diagnostics from the last reload (niri-style)'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "check-config" -d 'Validate the user\'s config (niri-style diagnostics)'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "rules" -d 'Dry-run windowrules against an app_id / title pair'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "completions" -d 'Generate a shell-completion script (bash / zsh / fish / elvish / powershell)'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "doctor" -d 'Health check — config, socket, version sync, GPU, services in one pass'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "clients" -d 'List every open window with tag, monitor, app_id, title'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "outputs" -d 'List every connected output with mode, position, scale, layout'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "perf" -d 'Per-output frame counters: renders, empties, empty ratio, queue errors'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "focused" -d 'Print the focused window\'s app_id + title (terse, scriptable)'
complete -c mctl -n "__fish_mctl_using_subcommand help; and not __fish_seen_subcommand_from dispatch log plugin run migrate tags client-tags layout quit reload theme session-save session-load get watch status actions twilight config-errors check-config rules completions doctor clients outputs perf focused help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
