...
mshell uses a subset of [Nerd Fonts](https://www.nerdfonts.com/)
...
project file `mshell_custom_icon_project.gs2`.
...
The project file is `mshell_custom_icon_project.gs2`.
