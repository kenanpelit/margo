...
pub const ACTIONS: &[Action] = &[
    ...
    Action {
        name: "overview_pan_left",
        aliases: &[],
        args: "",
        group: Group::Overview,
        summary: "Spatial overview: pan camera one screen-step left.",
        detail: "Step is 480 logical px, scaled by 1/zoom so the visible-world delta stays \"one screen step\" at any zoom. No-op outside spatial overview.",
    },
    Action {
        name: "overview_pan_right",
        aliases: &[],
        args: "",
        group: Group::Overview,
        summary: "Spatial overview: pan camera one screen-step right.",
        detail: "Mirror of `overview_pan_left`.",
    },
    Action {
        name: "overview_pan_up",
        aliases: &[],
        args: "",
        group: Group::Overview,
        summary: "Spatial overview: pan camera one screen-step up.",
        detail: "Step is 270 logical px (¼ of a 1080p panel height).",
    },
    Action {
        name: "overview_pan_down",
        aliases: &[],
        args: "",
        group: Group::Overview,
        summary: "Spatial overview: pan camera one screen-step down.",
        detail: "Mirror of `overview_pan_up`.",
    },
    Action {
        name: "overview_zoom_in",
        aliases: &[],
        args: "",
        group: Group::Overview,
        summary: "Spatial overview: zoom camera in by 1.2× (capped at ZOOM_MAX = 1.5).",
        detail: "Centred on the work-area centre (not cursor-anchored — scroll-wheel zoom is). Bind to super+= or similar.",
    },
    Action {
        name: "overview_zoom_out",
        aliases: &[],
        args: "",
        group: Group::Overview,
        summary: "Spatial overview: zoom camera out by 1.2× (capped at ZOOM_MIN = 0.1).",
        detail: "Mirror of `overview_zoom_in`.",
    },
    Action {
        name: "overview_zoom_reset",
        aliases: &["overview_reset_camera"],
        args: "",
        group: Group::Overview,
        summary: "Spatial overview: snap camera to active tag centre at default zoom.",
        detail: "Useful as a 'reset view' bind when the user has wandered to an empty corner. Reads `overview_zoom` config for the target zoom level.",
    },
