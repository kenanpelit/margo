...
/// Eventide — a dusk palette. Deep twilight blue-violet surfaces, a
/// bioluminescent teal primary, and twilight-violet / sunset-amber / rose
/// accents: calm and professional, with a jewel-like glow.
pub fn eventide(mshell: MShell) -> MatugenTheme {
    MatugenTheme {
        mshell,
        image: String::new(),
        is_dark_mode: true,
