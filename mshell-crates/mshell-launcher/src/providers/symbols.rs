...
const SYMBOLS: &[Symbol] = &[
    ...
    Symbol {
        ...
        keywords: &["arrow", "right", "rarr", "to"],
    },
    Symbol {
        char: "←",
        name: "Leftwards arrow",
        keywords: &["arrow", "left", "larr", "from"],
    },
    Symbol {
        char: "↑",
        name: "Upwards arrow",
        keywords: &["arrow", "up", "uarr"],
    },
    Symbol {
        char: "↓",
        name: "Downwards arrow",
        keywords: &["arrow", "down", "darr"],
    },
    Symbol {
        char: "↔",
        name: "Left-right arrow",
        keywords: &["arrow", "horizontal", "harr"],
    },
    Symbol {
        char: "↕",
        name: "Up-down arrow",
        keywords: &["arrow", "vertical", "varr"],
    },
    Symbol {
        char: "⇒",
        name: "Rightwards double arrow",
        keywords: &["arrow", "implies", "rArr"],
    },
    Symbol {
        char: "⇐",
    ...
    Symbol {
        ...
        keywords: &["arrow", "iff", "hArr"],
    },
    Symbol {
        char: "↩",
        name: "Leftwards arrow with hook",
        keywords: &["arrow", "return", "enter"],
    },
    Symbol {
        char: "↪",
    ...
    Symbol {
        ...
        keywords: &["arrow", "swap", "exchange"],
    },
    Symbol {
        char: "⟶",
        name: "Long rightwards arrow",
        keywords: &["arrow", "long", "right"],
    },
    Symbol {
        char: "⟵",
    ...
    Symbol {
        ...
        keywords: &["arrow", "long", "implies"],
    },
    // ── Math ────────────────────────────────────────────
    Symbol {
        char: "±",
        name: "Plus-minus",
        keywords: &["plusminus", "pm", "math"],
    },
    Symbol {
        char: "∓",
        name: "Minus-plus",
    ...
    Symbol {
        char: "≠",
        name: "Not equal to",
        keywords: &["neq", "ne", "math"],
    },
    Symbol {
        char: "≤",
        name: "Less-than or equal",
        keywords: &["leq", "le", "math"],
    },
    Symbol {
        char: "≥",
        name: "Greater-than or equal",
        keywords: &["geq", "ge", "math"],
    },
    Symbol {
        char: "≈",
        name: "Almost equal to",
        keywords: &["approx", "math"],
    },
    Symbol {
        char: "≡",
        name: "Identical to",
    ...
    Symbol {
        char: "∏",
        name: "Product",
        keywords: &["product", "prod", "pi", "math"],
    },
    Symbol {
        char: "∫",
        name: "Integral",
        keywords: &["integral", "int", "math"],
    },
    Symbol {
        char: "√",
        name: "Square root",
        keywords: &["sqrt", "root", "math"],
    },
    Symbol {
        char: "∂",
        name: "Partial differential",
        keywords: &["partial", "math"],
    },
    Symbol {
        char: "∇",
        name: "Nabla",
        keywords: &["nabla", "del", "gradient", "math"],
    },
    Symbol {
        char: "∆",
        name: "Increment / triangle",
        keywords: &["delta", "math"],
    },
    Symbol {
        char: "°",
        name: "Degree sign",
        keywords: &["deg", "degree", "math"],
    },
    Symbol {
        char: "%",
        name: "Percent sign",
    ...
    Symbol {
        char: "∈",
        name: "Element of",
        keywords: &["in", "math", "set"],
    },
    Symbol {
        char: "∉",
        name: "Not an element of",
        keywords: &["notin", "math", "set"],
    },
    Symbol {
        char: "⊂",
        name: "Subset of",
        keywords: &["subset", "math"],
    },
    Symbol {
        char: "⊃",
        name: "Superset of",
        keywords: &["supset", "math"],
    },
    Symbol {
        char: "∪",
        name: "Union",
        keywords: &["union", "math", "set"],
    },
    Symbol {
        char: "∩",
        name: "Intersection",
        keywords: &["intersection", "math", "set"],
    },
    Symbol {
        char: "∅",
        name: "Empty set",
        keywords: &["empty", "math", "null"],
    },
    Symbol {
        char: "∀",
        name: "For all",
        keywords: &["forall", "math", "logic"],
    },
    Symbol {
        char: "∃",
        name: "There exists",
    ...
    Symbol {
        char: "¬",
        name: "Logical not",
        keywords: &["not", "neg", "logic"],
    },
    Symbol {
        char: "∧",
        name: "Logical and",
        keywords: &["and", "wedge", "logic"],
    },
    Symbol {
        char: "∨",
        name: "Logical or",
        keywords: &["or", "vee", "logic"],
    },
    Symbol {
        char: "⊕",
        name: "Exclusive or",
        keywords: &["xor", "oplus", "logic"],
    },
    // ── Greek (lowercase common) ────────────────────────
    Symbol {
        char: "α",
        name: "Alpha",
        keywords: &["greek", "alpha"],
    },
    Symbol {
        char: "β",
        name: "Beta",
    ...
    Symbol {
        char: "γ",
        name: "Gamma",
        keywords: &["greek", "gamma"],
    },
    Symbol {
        char: "δ",
        name: "Delta (lowercase)",
        keywords: &["greek", "delta"],
    },
    Symbol {
        char: "ε",
        name: "Epsilon",
    ...
    Symbol {
        char: "λ",
        name: "Lambda",
        keywords: &["greek", "lambda"],
    },
    Symbol {
        char: "μ",
        name: "Mu",
        keywords: &["greek", "mu", "micro"],
    },
    Symbol {
        char: "π",
        name: "Pi",
    ...
    Symbol {
        char: "ω",
        name: "Omega",
        keywords: &["greek", "omega"],
    },
    Symbol {
        char: "Σ",
        name: "Sigma (uppercase)",
        keywords: &["greek", "sigma", "sum"],
    },
    Symbol {
        char: "Δ",
    ...
    Symbol {
        char: "£",
        name: "Pound sign",
        keywords: &["currency", "gbp", "pound"],
    },
    Symbol {
        char: "¥",
        name: "Yen / yuan sign",
        keywords: &["currency", "yen", "yuan", "jpy", "cny"],
    },
    Symbol {
        char: "₺",
        name: "Turkish lira sign",
        keywords: &["currency", "lira", "try"],
    },
    Symbol {
        char: "₽",
        name: "Ruble sign",
        keywords: &["currency", "rub", "ruble"],
    },
    Symbol {
        char: "₹",
        name: "Rupee sign",
        keywords: &["currency", "inr", "rupee"],
    },
    Symbol {
        char: "¢",
        name: "Cent sign",
        keywords: &["currency", "cent"],
    },
    Symbol {
        char: "₿",
        name: "Bitcoin sign",
        keywords: &["currency", "btc", "bitcoin", "crypto"],
    },
    // ── Typography ──────────────────────────────────────
    Symbol {
        char: "—",
        name: "Em dash",
        keywords: &["dash", "em", "punct"],
    },
    Symbol {
        char: "–",
        name: "En dash",
        keywords: &["dash", "en", "punct"],
    },
    Symbol {
        char: "…",
        name: "Horizontal ellipsis",
        keywords: &["ellipsis", "dots", "punct"],
    },
    Symbol {
        char: "•",
        name: "Bullet",
        keywords: &["bullet", "list", "punct"],
    },
    Symbol {
        char: "·",
        name: "Middle dot",
        keywords: &["middot", "punct"],
    },
    Symbol {
        char: "‘",
        name: "Left single quote",
        keywords: &["quote", "lsquo", "punct"],
    },
    Symbol {
        char: "’",
        name: "Right single quote / apostrophe",
        keywords: &["quote", "rsquo", "punct"],
    },
    Symbol {
        char: "“",
        name: "Left double quote",
        keywords: &["quote", "ldquo", "punct"],
    },
    Symbol {
        char: "”",
        name: "Right double quote",
        keywords: &["quote", "rdquo", "punct"],
    },
    Symbol {
        char: "«",
        name: "Left guillemet",
        keywords: &["quote", "guillemet", "punct"],
    },
    Symbol {
        char: "»",
    ...
    Symbol {
        char: "§",
        name: "Section sign",
        keywords: &["section", "punct", "law"],
    },
    Symbol {
        char: "¶",
        name: "Pilcrow / paragraph",
        keywords: &["pilcrow", "paragraph", "punct"],
    },
    Symbol {
        char: "†",
        name: "Dagger",
        keywords: &["dagger", "footnote", "punct"],
    },
    Symbol {
        char: "‡",
        name: "Double dagger",
    ...
    Symbol {
        char: "℠",
        name: "Service mark",
        keywords: &["servicemark", "sm", "legal"],
    },
    // ── Shapes ──────────────────────────────────────────
    Symbol {
        char: "★",
        name: "Black star",
        keywords: &["star", "filled", "shape"],
    },
    Symbol {
        char: "☆",
        name: "White star",
        keywords: &["star", "outline", "shape"],
    },
    Symbol {
        char: "♥",
        name: "Heart suit",
    ...
    Symbol {
        char: "♠",
        name: "Spade suit",
        keywords: &["spade", "shape"],
    },
    Symbol {
        char: "✓",
        name: "Check mark",
        keywords: &["check", "tick", "yes", "ok"],
    },
    Symbol {
        char: "✗",
        name: "Ballot X",
        keywords: &["x", "cross", "no", "wrong"],
    },
    Symbol {
        char: "✔",
        name: "Heavy check mark",
        keywords: &["check", "tick", "yes", "heavy"],
    },
    Symbol {
        char: "✘",
        name: "Heavy ballot X",
        keywords: &["x", "cross", "no", "heavy"],
    },
    Symbol {
        char: "●",
        name: "Black circle",
        keywords: &["circle", "dot", "shape"],
    },
    Symbol {
        char: "○",
        name: "White circle",
        keywords: &["circle", "outline", "shape"],
    },
    Symbol {
        char: "■",
        name: "Black square",
    ...
    Symbol {
        char: "□",
        name: "White square",
        keywords: &["square", "outline", "shape"],
    },
    Symbol {
        char: "▲",
        name: "Black up-pointing triangle",
        keywords: &["triangle", "up", "shape"],
    },
    Symbol {
        char: "▼",
        name: "Black down-pointing triangle",
        keywords: &["triangle", "down", "shape"],
    },
    Symbol {
        char: "◆",
        name: "Black diamond",
    ...
    Symbol {
        char: "◇",
        name: "White diamond",
        keywords: &["diamond", "outline", "shape"],
    },
    // ── Box drawing (light) ─────────────────────────────
    Symbol {
        char: "─",
        name: "Box drawing horizontal",
        keywords: &["box", "line", "horizontal"],
    },
    Symbol {
        char: "│",
        name: "Box drawing vertical",
        keywords: &["box", "line", "vertical"],
    },
    Symbol {
        char: "┌",
        name: "Box drawing top-left",
        keywords: &["box", "corner"],
    },
    Symbol {
        char: "┐",
        name: "Box drawing top-right",
        keywords: &["box", "corner"],
    },
    Symbol {
        char: "└",
        name: "Box drawing bottom-left",
        keywords: &["box", "corner"],
    },
    Symbol {
        char: "┘",
        name: "Box drawing bottom-right",
        keywords: &["box", "corner"],
    },
    Symbol {
        char: "├",
        name: "Box drawing tee right",
        keywords: &["box", "tee"],
    },
    Symbol {
        char: "┤",
        name: "Box drawing tee left",
        keywords: &["box", "tee"],
    },
    Symbol {
        char: "┬",
        name: "Box drawing tee down",
        keywords: &["box", "tee"],
    },
    Symbol {
        char: "┴",
        name: "Box drawing tee up",
        keywords: &["box", "tee"],
    },
    Symbol {
        char: "┼",
        name: "Box drawing cross",
        keywords: &["box", "cross"],
    },
    // ── Misc useful ─────────────────────────────────────
    Symbol {
        char: "⌘",
        name: "Command (Mac)",
        keywords: &["command", "mac", "key"],
    },
    Symbol {
        char: "⌥",
        name: "Option (Mac)",
        keywords: &["option", "mac", "key", "alt"],
    },
    Symbol {
        char: "⌃",
        name: "Control (Mac)",
        keywords: &["control", "ctrl", "mac", "key"],
    },
    Symbol {
        char: "⇧",
        name: "Shift",
    ...
    Symbol {
        char: "⏎",
        name: "Return / enter",
        keywords: &["return", "enter", "key"],
    },
    Symbol {
        char: "⌫",
        name: "Backspace",
        keywords: &["backspace", "key"],
    },
    Symbol {
        char: "⌦",
        name: "Delete forward",
