...
impl Component for SettingsWindowModel {
    ...
    fn init(
        ...
        let mut entries: Vec<WidgetEntry> = vec![
            ...
            WidgetEntry::Pill { kind: BarPillKind::CpuDashboard, stack_name: "pill_cpu_dashboard", label: "CPU Dashboard", icon: "computer-symbolic" },
            WidgetEntry::Pill { kind: BarPillKind::CpuMonitor, stack_name: "pill_cpu_monitor", label: "CPU Load", icon: "computer-symbolic" },
            WidgetEntry::Pill { kind: BarPillKind::CpuTemp, stack_name: "pill_cpu_temp", label: "CPU Temperature", icon: "temperature-symbolic" },
            WidgetEntry::Pill { kind: BarPillKind::KeepAwake, stack_name: "pill_keep_awake", label: "Keep Awake", icon: "eye-symbolic" },
            WidgetEntry::Pill { kind: BarPillKind::RamMonitor, stack_name: "pill_ram_monitor", label: "RAM Used", icon: "drive-harddisk-symbolic" },
