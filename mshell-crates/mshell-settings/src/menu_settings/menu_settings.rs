...
impl Component for MenuSettingsModel {
    ...
    view! {
        ...
        gtk::ScrolledWindow {
            ...
            gtk::Box {
                ...
                gtk::Label {
                    add_css_class: "label-large-bold",
                    set_label: "Network Console Menu",
                    set_halign: gtk::Align::Start,
                },
                ...
                gtk::Box {
                    ...
                    gtk::DropDown {
                        ...
                        set_model: Some(&gtk::StringList::new(&Position::display_names())),
                        #[watch]
                        #[block_signal(nnetwork_pos_handler)]
                        set_selected: model.nnetwork_position.to_index(),
                        connect_selected_notify[sender] => move |dd| {
                            sender.input(MenuSettingsInput::NnetworkPositionChanged(
                                Position::from_index(dd.selected())
                            ));
                        } @nnetwork_pos_handler,
                    },
                },
                ...
                gtk::Box {
                    ...
                    gtk::SpinButton {
                        ...
                        set_increments: (10.0, 50.0),
                        #[watch]
                        #[block_signal(nnetwork_min_width_handler)]
                        set_value: model.nnetwork_min_width as f64,
                        connect_value_changed[sender] => move |s| {
                ...
                model.nnetwork_widget_list_controller.widget().clone() {},

                gtk::Separator {},

                gtk::Label {
                    add_css_class: "label-large-bold",
                    set_label: "Power Profile Menu",
                    set_halign: gtk::Align::Start,
                },
                ...
                gtk::Box {
                    ...
                    gtk::DropDown {
                        ...
                        set_model: Some(&gtk::StringList::new(&Position::display_names())),
                        #[watch]
                        #[block_signal(npower_pos_handler)]
                        set_selected: model.npower_position.to_index(),
                        connect_selected_notify[sender] => move |dd| {
                            sender.input(MenuSettingsInput::NpowerPositionChanged(
                                Position::from_index(dd.selected())
                            ));
                        } @npower_pos_handler,
                    },
                ...
                gtk::Box {
                    ...
                    gtk::SpinButton {
                        ...
                        set_increments: (10.0, 50.0),
                        #[watch]
                        #[block_signal(npower_min_width_handler)]
                        set_value: model.npower_min_width as f64,
                        connect_value_changed[sender] => move |s| {
                            sender.input(MenuSettingsInput::NpowerMinWidthChanged(s.value() as i32));
                        } @npower_min_width_handler,
                    },
                },
    ...
    fn init(
        ...
        effects.push(move |_| {
            let config = config_manager().config();
            let value = config.menus().nnetwork_menu().position().get();
            sender_clone.input(MenuSettingsInput::NnetworkPositionEffect(value));
        });
        let sender_clone = sender.clone();
        effects.push(move |_| {
            let config = config_manager().config();
        ...
        effects.push(move |_| {
            let config = config_manager().config();
            let value = config.menus().nnetwork_menu().widgets().get();
            sender_clone.input(MenuSettingsInput::NnetworkWidgetListEffect(value));
        });

        let sender_clone = sender.clone();
        effects.push(move |_| {
            let config = config_manager().config();
            let value = config.menus().npower_menu().position().get();
            sender_clone.input(MenuSettingsInput::NpowerPositionEffect(value));
        });
        let sender_clone = sender.clone();
        effects.push(move |_| {
            let config = config_manager().config();
        ...
        effects.push(move |_| {
            let config = config_manager().config();
            let value = config.menus().npower_menu().widgets().get();
            sender_clone.input(MenuSettingsInput::NpowerWidgetListEffect(value));
        });
        ...
        let nnetwork_widget_list_controller = MenuWidgetListModel::builder()
            .launch(MenuWidgetListInit {
                widgets: config_manager()
                    .config()
                    .menus()
        ...
        let npower_widget_list_controller = MenuWidgetListModel::builder()
            .launch(MenuWidgetListInit {
                widgets: config_manager()
                    .config()
                    .menus()
        ...
        let model = MenuSettingsModel {
            ...
            nnetwork_position: config_manager()
                ...
                .position()
                .get_untracked(),
            nnetwork_min_width: config_manager()
                .config()
                .menus()
                .nnetwork_menu()
                .minimum_width()
            ...
            npower_position: config_manager()
                ...
                .position()
                .get_untracked(),
            npower_min_width: config_manager()
                .config()
                .menus()
                .npower_menu()
                .minimum_width()
    ...
    fn update_with_view(
        ...
        match message {
            ...
            MenuSettingsInput::NnetworkWidgetListChanged(widgets) => {
                config_manager().update_config(|config| {
                    config.menus.nnetwork_menu.widgets = widgets;
                });
            }
            MenuSettingsInput::NnetworkPositionChanged(position) => {
                self.nnetwork_position = position.clone();
                config_manager().update_config(|config| {
                    config.menus.nnetwork_menu.position = position;
                });
            }
            MenuSettingsInput::NnetworkMinWidthChanged(width) => {
            ...
            MenuSettingsInput::NpowerPositionChanged(position) => {
                self.npower_position = position.clone();
                config_manager().update_config(|config| {
                    config.menus.npower_menu.position = position;
                });
            }
            MenuSettingsInput::NpowerMinWidthChanged(width) => {
            ...
            MenuSettingsInput::NnetworkPositionEffect(position) => {
                self.nnetwork_position = position;
            }
            ...
            MenuSettingsInput::NpowerPositionEffect(position) => {
                self.npower_position = position;
            }
